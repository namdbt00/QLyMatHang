...
<div id="logreg-forms">
    ...
    <form class="form-signin" action="CheckLoginServlet" method="post">
        ...
        <div onclick="alert('Không có chức năng này')" id="forgot_pswd">Quên mật khẩu</div>
        <hr>
        <!-- <p>Don't have an account!</p>  -->
        <button class="btn btn-primary btn-block" onclick="alert('Không có chức năng này')" type="button" id="btn-signup"><i class="fas fa-user-plus"></i> Đăng ký tài khoản mới</button>
    </form>
